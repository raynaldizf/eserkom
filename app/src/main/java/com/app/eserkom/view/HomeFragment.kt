...
import com.app.eserkom.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.formulir.setOnClickListener{
            findNavController().navigate(R.id.action_homeFragment_to_formEntryFragment)
        }

        binding.listData.setOnClickListener{
